...
conv1 = tf.keras.layers.Conv1D(filters=100, kernel_size=50, padding='valid')  # no zero padding
pool1 = tf.keras.layers.MaxPooling1D(pool_size=51, strides=1)
...
adadelta = tf.keras.optimizers.Adadelta(lr=.01, rho=0.95, epsilon=None, decay=0.0)
